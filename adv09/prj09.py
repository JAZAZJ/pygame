...
####################翼龍物件#######################
ptera_x = bg_x - 100
petra_y = PTERA_LIMIT_LOW
petra_index = 0
petra_shift = 10
petra_center_x = ptera_x + img_ptera[0].get_width() / 2
ptra_center_y = ptera_x + img_ptera[0].get_height() / 2
petra_detect_r = max(img_ptera[0].get_width(),img_ptera[0].get_height() / 2 - 10)
######################建立視窗######################
